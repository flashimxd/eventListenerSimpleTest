...
describe('emitting events', () => {
  test.skip('.emit() - should emit an event and execute all listeners callbacks', () => {
    const emitter = EventEmitter.create()
    const [callback1, callback2] = [jest.fn(), jest.fn()]
  ...
  test.skip('.emit() - should pass event data, as the second argument, to all callbacks', () => {
    const emitter = EventEmitter.create()
    const callback = jest.fn()
  ...
  test.skip('.emit() - should pass event `type` to all callbacks', () => {
    const emitter = EventEmitter.create()
    const callback = jest.fn()
  ...
  test.skip('.emit() - should do nothing if event has no callbacks', () => {
    const emitter = EventEmitter.create()
...
describe('special listeners', () => {
  describe('once()', () => {
    test.skip('should listen to an event only once', () => {
      const emitter = EventEmitter.create()
    ...
    test.skip('should return a method to cancel the listener', () => {
      const emitter = EventEmitter.create()
    ...
    test.skip('listener should received the event data', () => {
      const emitter = EventEmitter.create()
    ...
    test.skip('should guarantee every callback is executed and only .once() are removed', () => {
      const emitter = EventEmitter.create()
  ...
  describe('race()', () => {
    test.skip('should accept an array of [event, callback], execute listeners of first emitted event and unlisten all of them', () => {
      const emitter = EventEmitter.create()
    ...
    test.skip('should return a method which cancels all listeners', () => {
      const emitter = EventEmitter.create()
    ...
    test.skip('should guarantee every callback is executed and only .race() callbacks are removed', () => {
      const emitter = EventEmitter.create()
